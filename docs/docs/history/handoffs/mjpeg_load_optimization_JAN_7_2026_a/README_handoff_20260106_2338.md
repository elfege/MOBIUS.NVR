...
```text
-i rtsp://...<LAN_IP>:554/h264Preview_01_main (BEFORE: _sub)
```
...
```text
reolink_aio.exceptions.UnexpectedDataError: Host <LAN_IP>:443 error mapping responses to requests, received 1 responses while requesting 20 responses
```

**Affected Cameras:**

- REOLINK OFFICE (95270001CSO4BPDZ) - <LAN_IP>
- Terrace South (95270001CSHLPO74) - <LAN_IP> (same model/firmware)
