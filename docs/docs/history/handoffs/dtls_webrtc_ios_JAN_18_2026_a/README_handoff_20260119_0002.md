...
- Ping works, HTTP MJPEG works, but `rtsp://<LAN_IP>:554/...` times out
...
```text
2026/01/18 21:21:43 INF [WebRTC] [session 6a5f3e40] peer connection established, local candidate: host/udp/127.0.0.1/8189, remote candidate: prflx/udp/<LAN_IP>/49290
```
