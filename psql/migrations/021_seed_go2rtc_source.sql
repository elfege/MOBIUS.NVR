...
UPDATE cameras SET go2rtc_source = 'rtsp://${NVR_REOLINK_API_USER}:${NVR_REOLINK_API_PASSWORD}@<LAN_IP>/h264Preview_01_main'
...
UPDATE cameras SET go2rtc_source = 'rtsp://${NVR_AMCREST_LOBBY_USERNAME}:${NVR_AMCREST_LOBBY_PASSWORD}@<LAN_IP>/cam/realmonitor?channel=1&subtype=0'
  WHERE serial = 'AMC043145A67EFBF79'; -- AMCREST LOBBY

UPDATE cameras SET go2rtc_source = 'rtsp://admin:${NVR_SV3C_PASSWORD}@<LAN_IP>:554/stream1'
