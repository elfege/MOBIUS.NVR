...
**Expected output:**
```
Built RTSP URL for Living Room: rtsp://Hs07XmLA7MT8zb3j:****@<LAN_IP>:554/live0
RTSP URL: rtsp://Hs07XmLA7MT8zb3j:Kq5PKqHhHaVLopXL@<LAN_IP>:554/live0
```
